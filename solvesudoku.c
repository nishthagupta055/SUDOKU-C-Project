...
int hard[9][9]={
 ...
 // function to add a number to sudoku
void add()
{
...
// function to delete a number from sudoku
void delete()
{
    int row,column,number;
...
// function to check the sudoku whether it is 
bool validate()
{
  ...
  for (int r = 0; r < 9; r++)
  {
      ...
      for (int c = 0; c< 9; c++) 
      {
         ...
         if(arr[r][c]==0)
         {
           printf("\nAll the empty space are to be filled before validation\n");
            return false;
         }
